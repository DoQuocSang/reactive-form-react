...
import ErrorMessage from "../validate/ErrorMessage.component";
              ...
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:leading-7">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    {fields.map((field, index) => {
                      const error = errors.tags?.[index]?.name;
                      return (
                        <div
                          key={field.id}
                          className={
                            "flex justify-center items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs " +
                            (error
                  ...
                  {Array.isArray(errors.tags) &&
                    errors.tags?.some((error) => !!error?.name?.message) && (
                      <ErrorMessage
                        message={
                          errors.tags.find((tag) => tag != null)?.name?.message
                        }
                      />
                    )}
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    placeholder="Type name"
                  />
                  {errors.offer?.discountCode?.message && (
                    <div className="flex items-center justify-between">
                      <ErrorMessage
                        message={errors.offer?.discountCode?.message}
                      />
                ...
                <div className="flex items-center justify-end gap-2">
                  ...
                  <div className="w-5 h-5 relative">
                    <input
                      ...
                      type="checkbox"
                      id="visible"
                      className="peer appearance-none cursor-pointer w-full h-full bg-red-100 rounded border-none focus:ring-0 checked:bg-emerald-500 transition-all duration-150 ease-in-out"
                    />

                    <Check className="peer-checked:visible invisible size-5 text-white absolute top-0 left-0 pointer-events-none" />
                  </div>
                </div>
              </div>
